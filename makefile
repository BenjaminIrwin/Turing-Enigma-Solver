main: main.o helper.o plugboard.o rotor.o reflector.o
	g++ main.o helper.o plugboard.o rotor.o reflector.o -o main

main.o: main.cpp helper.h errors.h plugboard.h reflector.h rotor.h
	g++ -Wall -g -c main.cpp
